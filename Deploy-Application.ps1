...
Try {
	...
	[string]$appScriptDate = '08/30/2016'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		#Execute-Process -Path "minitab17.3.1.0setup.exe" -Parameters "/exenoui /exelang 1033 /qn ACCEPT_EULA=1 LICENSE_SERVER=vmwas22 LICENSE_SERVER_PORT=27090 DISABLE_UPDATES=1" -WindowStyle "Hidden" -IgnoreExitCodes "3010"
		Execute-Process -Path "mtben1710mu.exe" -Parameters "/config `"$dirSupportFiles\config.xml`"" -WindowStyle "Hidden" -IgnoreExitCodes "3010"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$envCommonProgramFilesX86\Minitab Shared\Minitab 17\Setup\Setup.exe" -Parameters "/p Minitab17 /x /qn" -WindowStyle "Hidden"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAnWN3sNGytaHnN
# f1prjjsz0+/RWid9MC4pGiZWYLS5RqCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIL9N
# zEQozYldTrza22TviX/P11uKBEe5n0uwyZAoIxxCMA0GCSqGSIb3DQEBAQUABIIB
# AEus8FfNJDR6jxMevkUnVyHs2l0YlJpk+CtwvQHwowadeb7E8fyvo+X0uaOATC6g
# 4KHkXX8Iy8HL5US1VO5XeXJId47Uure6buBuG6MNZ3rJeAmCizUDD8pi3wdfhq7H
# 382oObYTtFx8m03aYpS/K9EJHgnhAr4tc/FylL9gjB1+Up6J7Me6P5IIxOSXK9sf
# obD6CL/dOc9x8x/TmHRRPxmgf3IL/TBVDd2DRkDvkkRd6yezQYZZZAEuG/3i7nzz
# FhG7v8ttWFY1I7dSqkJdqz+e+PNHQAxL31ezyj47g6/SMFpJpOnh5yijD0tmKqKu
# SUvUjeMWwMIvtRl8CF8+6rOhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTYwOTAxMTQ1OTI3WjAjBgkqhkiG9w0BCQQxFgQU
# 2xIhJJLmhSj1ydo0saGdgYT9zIIwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAFXe5+HZxERH+2pXDPTzPt98+GQra6GxRkBzqNshYA5OpTaQdJf1tU+O
# UhLlMVUfakdbho11n+dfz1hKuWh0AfMypHLoWrHClhjkfKPYirRusRFzhLOoms/j
# yOTWSwhqCtPl67Gt88zFInhjcXuL/n9jo+vfVwG8OHOM5JqXHKkUYIpumfJQblE8
# do+3XW08qyM3dy7KeDNp8+iqznYR2LzpwjolYXlWSIn1mGPE25uGQtYUjTJzahQO
# wwCVe+24YgHdr36V8NbpzCEuEI6kJZlxwN9rgSRr9Cwt1WO2OpU0VNTHJWxGHftH
# eoA57x3HXQ5rXNAM+2i5Mej2pgyrluE=
